...
exports.aggregateReceiverEarningsByReceiver = aggregateReceiverEarningsByReceiver;
exports.sumReceiverEarningsRollup = sumReceiverEarningsRollup;
...
const RESOLVED_RECEIVER_PAYOUT_EXPR = receiverCallEarnings_1.RESOLVED_RECEIVER_CALL_EARNING_EXPR;
function emptyRollup() {
    return { callPayout: 0, chatPayout: 0, earnings: 0, calls: 0 };
}
function mergeRollup(call, chat) {
    const callPayout = (0, receiverCallEarnings_1.roundInr)(call.payout);
    const chatPayout = (0, receiverCallEarnings_1.roundInr)(chat.payout);
    return {
        callPayout,
        chatPayout,
        earnings: (0, receiverCallEarnings_1.roundInr)(callPayout + chatPayout),
        calls: call.calls,
    };
}
/**
 ...
 */
async function aggregateReceiverEarningsByReceiver(receiverIds, todayStart, weekStart, monthStart) {
    const out = new Map();
...
function sumReceiverEarningsRollup(rollups, period) {
    let callPayout = 0;
    let chatPayout = 0;
    let calls = 0;
