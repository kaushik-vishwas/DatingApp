...
const walletOfferSchema = new mongoose_1.Schema({
...
const WalletOffer = mongoose_1.default.models.WalletOffer ?? mongoose_1.default.model('WalletOffer', walletOfferSchema);
exports.default = WalletOffer;
