...
const receiverRatingSchema = new mongoose_1.Schema({
    receiverId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Receiver', required: true, index: true },
    raterId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
...
const ReceiverRating = mongoose_1.default.model('ReceiverRating', receiverRatingSchema);
exports.default = ReceiverRating;
