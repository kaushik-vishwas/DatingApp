...
const receiverDailyScoreSchema = new mongoose_1.Schema({
...
const ReceiverDailyScore = mongoose_1.default.model('ReceiverDailyScore', receiverDailyScoreSchema);
exports.default = ReceiverDailyScore;
